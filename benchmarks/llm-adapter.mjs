      ...
      return {
        content: JSON.stringify({
          review_result: {
            ...
            summary: 'The code change introduces important functionality but has critical security issues that must be addressed before merge.'
          }
        }, null, 2),
        stopReason: 'end_turn',
        inputTokens: 245,
          ...
          research_report: {
            ...
            key_findings: [
              ...
              },
              {
                ...
                supporting_evidence: ['Multiple studies show 30-50% reduction in test case generation time'],
                source_refs: ['acm-software-testing-2024']
              },
              {
                finding: 'Security concerns remain about AI-generated code quality',
                supporting_evidence: ['OWASP reported vulnerabilities in AI-generated code samples'],
                source_refs: ['owasp-ai-security-2024']
              }
            ],
            sources: [
              { name: 'GitHub Copilot Study', type: 'industry', reliability: 'high' },
              { name: 'Stack Overflow Developer Survey 2024', type: 'industry', reliability: 'high' },
              { name: 'ACM Software Testing Research', type: 'academic', reliability: 'high' }
            ],
            confidence_levels: { overall: 'high' },
            conclusion: 'AI is significantly impacting software development with productivity gains, though security and quality concerns require ongoing attention.'
          }
        }, null, 2),
        stopReason: 'end_turn',
        inputTokens: 198,
      ...
      return {
        content: JSON.stringify({
          audit_report: {
            ...
            remediation_plan: [
              { priority: 1, action: 'Fix SQL injection and API key exposure', effort: 'medium', timeline: 'immediate' },
              { priority: 2, action: 'Add input validation to file upload', effort: 'low', timeline: 'within 1 week' }
            ],
            risk_score: 82
          }
        }, null, 2),
